          ...
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:luanacampos.contato@gmail.com" className="text-muted-foreground text-sm hover:text-foreground transition-colors">
                  luanacampos.contato@gmail.com
                </a>
              </div>
            </div>
            <div className="flex items-start gap-4">
